...
export const Palette = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.422-.182-.833-.476-1.12-.297-.29-.703-.478-1.128-.478H11c-.926 0-1.648-.746-1.648-1.667 0-.422.182-.833.476-1.12.297-.29.703-.478 1.128-.478h.01c.926 0 1.648-.746 1.648-1.667 0-.422-.182-.833-.476-1.12-.297-.29-.703-.478-1.128-.478H12c-.926 0-1.648-.746-1.648-1.667 0-.422.182-.833.476-1.12.297-.29.703-.478 1.128-.478H12z" />
  </svg>
);

export const MoveVertical = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
